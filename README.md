...
- [ ] Mention two parts of Express that you learned about this week.
    I have learned how to create Middleware to add security and change the data before it reaches the database. Also how to create endpoints that can perform the CRUD operations. 
- [ ] Describe Middleware?
    It is a function that can be called to be a protection or blocker before a url or action can be invoked. 
- [ ] Describe a Resource?
    This is the data that is received when performing the CRUD operations. Can come in various formats. 
- [ ] What can the API return to help clients know if a request was successful?
    By sending the user a http status code, it will let them know that their request was successful, otherwise a failure status code can be used as well. 
- [ ] How can we partition our application into sub-applications?
    By breaking up the server, routers and data, it allows for a better construction of the application. 
## Project Setup
